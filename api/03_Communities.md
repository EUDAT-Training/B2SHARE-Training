...
It is possible to register new communities in B2SHARE, but currently not via the API. Please contact the [EUDAT helpdesk](https://eudat.eu/support-request?service=B2SHARE) in order to do so. If you are using your own instance of B2SHARE, you can configure a community directly using the provided tools. Refer to the [Community Administration](../deploy/12_Community_administration.md) guide of the [B2SHARE Deployment](../deploy) module on how to do this.
